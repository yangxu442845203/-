     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      <thead> 
       <tr role="row">
        ...
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 211px;">网站名称</th>
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 211px;">网站域名</th>
      ...
      @foreach($youqing as $row)
       <tr class="odd"> 
        <td class="  sorting_1">{{$row->id}}</td> 
        <td class=" ">{{$row->name}}</td>
        <td class=" ">{{$row->wangzhi}}</td>
        ...
        <button class="btn btn-success" type="submit"><i class="icon-trash"></i></button>
            <a class="btn btn-info" href="/adminyouqing/{{$row->id}}/edit"><i class="icon-wrench"></i></a></td>
          </form>
       </tr>
      @endforeach 
