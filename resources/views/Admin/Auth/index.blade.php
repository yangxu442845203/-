     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      <thead> 
       <tr role="row">
        ...
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 211px;">权限名字</th>
        ...
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 211px;">方法</th>
       ...
       <tr class="odd"> 
        ...
        <td class=" ">
        	<form action="/auth/{{$row->id}}" method="post">
        		...
        		<a class="btn btn-info" href="/auth/{{$row->id}}/edit"><i class="icon-wrench"></i></a></td>
        	</form>
       </tr>
       @endforeach
      </tbody>
