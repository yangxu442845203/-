<?php
	...
	function sendsphone($p){
		...
		$options['accountsid']='68dad267ccfb4e80a020c5b585064706';
		//填写在开发者控制台首页上的Auth Token
		$options['token']='72db1b1aa51478fd63f62f7ae130deeb';

		//初始化 $options必填
		$ucpass = new Ucpaas($options);
		$appid = "272aa80a61b24fc0adc54d14f11ddf21";	//应用的ID，可在开发者控制台内的短信产品下查看
		$templateid = "493425";    //可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID，必须通过审核
